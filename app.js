(function () {
  ...
  function removeRecord(collection, id) {
    ...
    if (!record) return;
    const name = record.title || record.role || record.source || "this record";
